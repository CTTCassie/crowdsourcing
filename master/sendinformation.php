...
<div data-options="region:'center',title:'移动应用众包测试系统管理子系统-发包方'" style="padding:5px;height:90%;background:#eee;">
    <table id="dd" class="easyui-datagrid" toolbar="#tb" style="width:100%;height:100%;font-size:50px">
        <div>
            ...
            <?php
                ...
                echo "&nbsp;&nbsp;";
                echo "<input type='button' class='btn btn-default' style='width:5;height:5;font-size:10px' onclick=$achieve value='发布项目'/>";
                echo "&nbsp;&nbsp;";
                echo "<input type='button' class='btn btn-default' style='width:5;height:5;font-size:10px' onclick=$myitem value='我的项目'/>";
            ?>
        </div>
    </table>
</div>
...
<script type="text/javascript" charset="utf-8">
    ...
    function getdata(arr) {
        datagrid = $("#dd").datagrid({
            url: "/master/send_updaterecord.php",  //请求的数据源
            ...
            
                {
                    ...
                    text: '删除', iconCls: 'icon-remove', handler: function () {
                        ...
                        if(row.length <= 0){
                            ...
                            $.ajax({
                                url: "send_updaterecord.php",  //请求的url地址  
