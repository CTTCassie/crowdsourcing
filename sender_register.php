...
<html lang="en">  
    ...
    <div class="page" width="100%">
        <form id="iterInfo" name="iterInfo" method="post" action="sender_register.php" class="form-inline" role="form">
            <div class="panel panel-success" width="100%">
                ...
                <div class="panel-body">
                    <center><label>发包方注册</label></center>
                    <center>手机号：&nbsp;&nbsp;&nbsp;
                    <input type="text"  id='telphone' class="form-control" style="width:200px;height:30px;" name="telphone" placeholder="请使用手机号注册"/></center><br />
                    <center>生日：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <center>简介：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <textarea id="introduce" name="introduce" class="form-control" style="width:200px;height:100px;" value="使用PHP">熟悉PHP</textarea></center>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <center>
    ...
    if($pdo)
    {
        ...
        if($telphone == "" || $birthday == "" || $title == "" || $education == "" || $password == "" || $password2 == "" || $introduce == "")//判断是否为空
        {
          ...
          echo"<script type="."\""."text/javascript"."\"".">"."window.location="."\""."sender_register.php"."\""."</script>";
          exit;
        }
        $sqlreg = "SELECT * FROM `senderinfo` WHERE `telphone`='{$telphone}'";
        ...
        if($password==$password2)//判断密码与确认密码是否一致
          {
            $sqlreg = "INSERT INTO `senderinfo` VALUES (null,'{$telphone}','{$birthday}','{$title}','{$education}','{$password}','{$introduce}','{$count}','{$date}')";
            $rw = $pdo->exec($sqlreg);
            if ($rw > 0) 
            {
            //echo"数据库关闭";
